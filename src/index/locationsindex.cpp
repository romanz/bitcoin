...
LocationsIndex::LocationsIndex(std::unique_ptr<interfaces::Chain> chain,
    ...
    : BaseIndex(std::move(chain), "locationsindex"), m_block_header_size(::GetSerializeSize(CBlockHeader{}))
{
...
bool LocationsIndex::ReadRawTransaction(uint256 block_hash, size_t i, std::vector<uint8_t>& out) const
{
